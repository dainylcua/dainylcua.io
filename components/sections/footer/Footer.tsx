...
export default function Footer() {
  return(
    <div className="bg-stone-900 p-4 md:p-16">
      <footer className="justify-between text-transparent bg-clip-text bg-gradient-to-br from-orange-500 to-rose-500  max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row h-fit items-start">
          <div className="flex flex-col md:w-1/2">
            ...
            <FooterLink name="Blog" href="https://dc-blog-omega.vercel.app/"/>
          </div>
          <div className="flex flex-col md:w-1/2">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-rose-500 h-[1.5px] rounded-full w-full mx-auto my-4 md:my-8" />
