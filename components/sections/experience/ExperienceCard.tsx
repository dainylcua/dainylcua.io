...
export default function ExperienceCard(props: Props) {
  const { reverse } = props
  return(
    <div className={`${ reverse ? `lg:items-end lg:self-end lg:text-end` : `` } flex flex-col bg-stone-200 lg:bg-transparent text-stone-900 p-2 w-full lg:w-fit shadow-2xl shadow-stone-900 my-4 rounded-md relative group`}>
