      ...
      <div className="flex items-center">
        ...
        <div className="hidden lg:block relative">
          ...
          <a href="https://www.linkedin.com/in/dainylcua/" target="_blank" rel="noopener noreferrer">
            <div className="rounded-full hover:scale-105 hover:ring-orange-300 ring-rose-300 transition duration-100 ring-4 h-[300px] w-[300px]">
              <Image src={profilePic} className="rounded-full filter sepia hover:filter-none transition duration-100" alt="Dainyl Cua"/>
            </div>
          </a>
        </div>
      </div>
