...
export default function Hero({}) {
  return(
    <header className="flex md:flex-row flex-col md:items-center py-16 text-lg md:justify-between w-[90vw] md:w-full border-b border-b-stone-800 max-w-3xl mx-auto h-screen">
