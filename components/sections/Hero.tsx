  ...
  return(
    <div className="bg-stone-800">
      <header id="hero" className="flex flex-col lg:items-center py-8 lg:py-16 text-xl w-full lg:h-[94vh] text-center relative overflow-hidden">
        ...
        <div className="w-full mx-auto px-8 text-center relative flex flex-col items-center  lg:mt-16">
          ...
          <h2 className="font-semibold text-stone-100 lg:text-4xl text-lg md:text-2xl pb-8 flex md:flex-row flex-col md:gap-4">
            <span>Fullstack Developer.</span>
            <span>Technical Writer.</span>
            <span>Endless Learner.</span>
            <span>D&D Fanatic.</span>
          </h2>
          <p className="pb-8 max-w-lg md:max-w-none md:text-lg text-base">
        ...
        <a
          ...
          className="bg-gradient-to-br from-orange-500 via-rose-500 to-orange-500 px-6 py-3 md:px-8 md:py-4 lg:px-10 lg:py-6 text-center w-fit self-center shadow-orange-900/50 flex rounded-md bg-size-200 bg-pos-0 hover:bg-pos-100 transition-all duration-500 text-lg md:text-xl lg:text-2xl font-bold hover:shadow-xl ease-out text-stone-50 hover:scale-95 z-10"
        >
          Contact Me
        </a>
      </header>
